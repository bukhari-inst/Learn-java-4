 ...
 * @author Bukhori
 */
public class KTPcoba extends javax.swing.JFrame {
    ...
    public void tampil(String Data) {
        ...
        try {
            namaobjek = new FileReader(Data);
        } catch (FileNotFoundException ex) {
            Logger.getLogger(KTPcoba.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void tombolcariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tombolcariActionPerformed
        ...
        int buka_dialog = chooser.showOpenDialog(KTPcoba.this);
    ...
    private void tombolsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tombolsimpanActionPerformed
        ...
        File file = new File("C://input5.txt");
        file.delete();
        ...
        try {
            FileWriter writer = new FileWriter("C://input5.txt", true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int res = chooser.showOpenDialog(KTPcoba.this);
...
//            jLabel2.setText(name);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KTPcoba.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
