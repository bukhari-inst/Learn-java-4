...
public class DocToTxt extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Convert Doc to Txt");
    ...
    public static String MembacaDocOrTxtFile() {
    ...
    public static void MencetakToTxtOrdocfile(String str) {
        ...
        try {
            java.io.File newTextFile1 = new java.io.File("D://Txthasilconvert.txt");
    ...
    private void tombolconvertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tombolconvertActionPerformed
        ...
        pathfileconvert.setText("D://Txthasilconvert.txt");
        System.out.println(MembacaDocOrTxtFile());
        System.out.println("Create Txt sukses!");
